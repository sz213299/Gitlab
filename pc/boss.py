...
drive.get('https://office.chaoxing.com/front/apps/seat/index?fidEnc=44c995c5894e50d9')
drive.implicitly_wait(8)
# 账号
drive.find_element(By.CLASS_NAME, 'ipt-tel').send_keys('13892222227')
time.sleep(2)
# 密码
drive.find_element(By.CLASS_NAME, 'ipt-pwd').send_keys('dyt20031030')

# 等待搜索结果加载
# 确定
drive.find_element(By.ID, 'loginBtn').click()
